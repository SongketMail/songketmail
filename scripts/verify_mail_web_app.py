#!/usr/bin/env python3
"""
verify_mail_web_app.py - Programmatic Core Service and Webmail Ingress Verification
Fully aligned with OKF v0.1, DSOM AI Protocol, and Rule 31 (Sandbox Mode fallback).
"""
            ...
            <aside class="lg:col-span-1 space-y-6">
                <div class="bg-white dark:bg-slate-800 rounded-xl p-4 border border-slate-200 dark:border-slate-800 shadow-sm">
                    ...
                    <nav class="space-y-1">
                        ...
                        <a href="architectural-blueprint.html" class="flex items-center space-x-2 px-3 py-2 rounded-lg text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 text-sm transition">
                            <span>📐</span>
